...
const DetailedProject = (props) => {
  ...
  return (
    <div
      className={styles.DetailedProject}
    >
      <div className={styles.Container}>
        ...
        <ButtonLink link={props.project.websiteURL}><FontAwesomeIcon icon={faExternalLinkAlt}/>Visit the website</ButtonLink>
        <ButtonLink link={props.project.sourceURL}><FontAwesomeIcon icon={faExternalLinkAlt}/>Visit the source</ButtonLink>
        </div>
